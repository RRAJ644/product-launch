...
import ProductInner from '@/components/custom/productInner'
import ProductAbout from '@/components/custom/ProductAbout'
...
const FeaturedProducts = async ({ params }: FeaturedProductProps) => {
  ...
  return <ProductInner product={product} />
}
